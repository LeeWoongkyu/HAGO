...
parser.add_argument('--tune', required=False, default=False, help='tune or not')
...
def test_quantize_acc(cfg, rec_val):
    ...
    acc = tune_eval(mod, params, val_data, batch_fn, tuning_option, target='cuda', ctx=tvm.gpu(2))
